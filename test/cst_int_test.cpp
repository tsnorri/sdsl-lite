...
cst_sct3<tCSA1, lcp_bitcompressed<> >,
         ...
         cst_sada<csa_rao<csa_rao_spec<2, 0, int_alphabet<>>>, lcp_bitcompressed<>>,
         cst_sada<csa_rao<csa_rao_spec<4, 0, int_alphabet<>>>, lcp_bitcompressed<>>,
         cst_sada<csa_rao<csa_rao_spec<5, 0, int_alphabet<>>>, lcp_bitcompressed<>>,
